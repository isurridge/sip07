$(function() {
	...
	$("form.main :input[id='hotelDeparture']").datepicker({
		...
		dateFormat: "DD, d MM, yy",
		onClose: function( selectedDate ) {
			$("form.main :input[id='hotelArrive']").datepicker( "option", "maxDate", selectedDate + "+1w");
		}
		});
	...
	$("form.main :input[id='airportArrive']").datepicker({
		...
		dateFormat: "DD, d MM, yy",
		onClose: function( selectedDate ) {
			$("form.main :input[id='airportDeparture']").datepicker( "option", "minDate", selectedDate );
		}
		});
	$("form.main :input[id='airportDeparture']").datepicker({
		...
		dateFormat: "DD, d MM, yy",
		onClose: function( selectedDate ) {
			$("form.main :input[id='airportArrive']").datepicker( "option", "maxDate", selectedDate + "+1w");
		}
		});
});
//dateFormat: "mm/dd/yy",